                                                                    ...
                                                                    <table class="table select-table">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex ">
                                                                                        <img src="{{ asset('assets/dashboard2/images/faces/face1.jpg') }}"
                                                                                            alt="">
                                                                                        <div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex">
                                                                                        <img src="{{ asset('assets/dashboard2/images/faces/face2.jpg') }}"
                                                                                            alt="">
                                                                                        <div>
                                                                                            <h6>Laura Brooks</h6>
                                                                                            <p>Head admin</p>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex">
                                                                                        <img src="{{ asset('assets/dashboard2/images/faces/face3.jpg') }}"
                                                                                            alt="">
                                                                                        <div>
                                                                                            <h6>Wayne Murphy</h6>
                                                                                            <p>Head admin</p>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex">
                                                                                        <img src="{{ asset('assets/dashboard2/images/faces/face4.jpg') }}"
                                                                                            alt="">
                                                                                        <div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="d-flex">
                                                                                        <img src="{{ asset('assets/dashboard2/images/faces/face5.jpg') }}"
                                                                                            alt="">
                                                                                        <div>
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <div class="mt-3">
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <img class="img-sm rounded-10"
                                                                                        src="{{ asset('assets/dashboard2/images/faces/face1.jpg') }}"
                                                                                        alt="profile">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <img class="img-sm rounded-10"
                                                                                        src="{{ asset('assets/dashboard2/images/faces/face2.jpg') }}"
                                                                                        alt="profile">
                                                                                    <div class="wrapper ms-3">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <img class="img-sm rounded-10"
                                                                                        src="{{ asset('assets/dashboard2/images/faces/face3.jpg') }}"
                                                                                        alt="profile">
                                                                                    <div class="wrapper ms-3">
                                                                                        <p class="ms-1 mb-1 fw-bold">
                                                                                            Katherine Butler</p>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <img class="img-sm rounded-10"
                                                                                        src="{{ asset('assets/dashboard2/images/faces/face4.jpg') }}"
                                                                                        alt="profile">
                                                                                    <div class="wrapper ms-3">
                                                                                        <p class="ms-1 mb-1 fw-bold">
                                                                                            Matthew Bailey</p>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <img class="img-sm rounded-10"
                                                                                        src="{{ asset('assets/dashboard2/images/faces/face5.jpg') }}"
                                                                                        alt="profile">
                                                                                    <div class="wrapper ms-3">
