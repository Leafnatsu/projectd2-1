        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"><a href="{{ route('promote.index') }}">Home</a></span> <span>Menu</span></p>
            </div>
    		...
    		<div class="row no-gutters d-flex">
    			<div class="col-lg-4 d-flex ftco-animate">
    				<div class="services-wrap d-flex">
    					<a href="#" class="img" style="background-image: url(assets/fn/images/20230409_183139.jpg);"></a>
    					<div class="text p-4">
    						<h3>Minced Beef Curry Rice</h3>
    						<p>ข้าวแกงกะหรี่เนื้อบด ข้าวสวยร้อน ราดด้วย แกงกะหรี่สูตรญี่ปุ่น ท็อปปิ้งเป็น เนื้อแฮมเบิร์กสูตร พิเศษ</p>
    						<p class="price"><span>99.00฿</span> <a href="#" class="ml-2 btn btn-white btn-outline-white">Order</a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-lg-4 d-flex ftco-animate">
    				<div class="services-wrap d-flex">
    					<a href="#" class="img" style="background-image: url(assets/fn/images/20230406_224440.jpg);"></a>
    					<div class="text p-4">
    						<h3>Beef Rice bowl</h3>
    						<p>ข้าวหน้าเนื้อ เป็นข้าวราด เนื้อผัด ด้วยหอมใหญ่ สไตล์ญี่ปุ่น</p>
    						<p class="price"><span>89.00฿</span> <a href="#" class="ml-2 btn btn-white btn-outline-white">Order</a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-lg-4 d-flex ftco-animate">
    				<div class="services-wrap d-flex">
    					<a href="#" class="img" style="background-image: url(assets/fn/images/20230407_185318.jpg);"></a>
    					<div class="text p-4">
    			...
    			<div class="col-lg-4 d-flex ftco-animate">
    				<div class="services-wrap d-flex">
    					<a href="#" class="img order-lg-last" style="background-image: url(assets/fn/images/20230407_193706.jpg);"></a>
    					<div class="text p-4">
    						<h3>Chicken Curry Rice</h3>
    						<p>ข้าวสวยร้อน ราดด้วย แกงกะหรี่สูตรญี่ปุ่น</p>
    						<p class="price"><span>79.00฿</span> <a href="#" class="ml-2 btn btn-white btn-outline-white">Order</a></p>
    					</div>
    				</div>
    			</div>
    			<div class="col-lg-4 d-flex ftco-animate">
    				<div class="services-wrap d-flex">
    					<a href="#" class="img order-lg-last" style="background-image: url(assets/fn/images/20230407_193841.jpg);"></a>
    					<div class="text p-4">
    			...
    			<div class="col-lg-4 d-flex ftco-animate">
    				<div class="services-wrap d-flex">
    					<a href="#" class="img order-lg-last" style="background-image: url(assets/fn/images/20230408_041200.jpg);"></a>
    					<div class="text p-4">
        	...
        	<div class="col-md-6">
                ...
                <div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			...
	        			<div class="d-block">
	        				<p>ทำจากแป้งพิซซ่า และซอสพิซซ่าสูตรพิเศษ โรยหน้าด้วยมอสซาเรลล่าชีส ใส่ท็อปปิ้งเป็น กุ้ง ปูอัด หมึกหลอด และสับปะรด โรยหน้าด้วยมอสซาเรลล่าชีสอีก 1 ชั้น</p>
	        			</div>
	        		</div>
        		</div>
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			...
	        			<div class="d-block">
	        				<p>ทำจากแป้งพิซซ่า และซอสพิซซ่า สูตรพิเศษ โรยหน้าด้วยมอสซาเรลล่าชีส ใส่ท็อปปิ้งเป็นไก่ซอสพะแนง และโรยหน้าทับด้วยมอสซาเรลล่าชีสอีก 1 ชั้น</p>
	        			</div>
	        		</div>
        		</div>
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			...
	        			<div class="d-block">
	        				<p>ทำจากแป้งพิซซ่าและซอสพิซซ่าสูตรพิเศษ โรยหน้าด้วยมอสซาเรลล่าชีส ใส่ท็อปปิ้ง เป็นไก่ในซอสเขียวหวาน โรยหน้าด้วยมอสซาเรลล่าชีสอีก 1 ชั้น</p>
	        			</div>
	        		</div>
        		</div>
        	</div>
        	...
        	<div class="col-md-6">
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			...
	        			<div class="d-block">
	        				<p>ทำจากแป้งพิซซ่าและซอสพิซซ่าสูตรพิเศษ โรยหน้าด้วยมอสซาเรลล่าชีส ใส่ท็อปปิ้ง เป็นแฮมไก่ และไส้กรอกรมควัน โรยหน้าทับด้วยมอสซาเรลล่าชีส อีก 1 ชั้น</p>
	        			</div>
	        		</div>
        		</div>
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			...
	        			<div class="d-block">
	        				<p>ทำจากแป้งพิซซ่า และซอสพิซซ่าสูตรพิเศษ โรยหน้าด้วยมอสซาเรลล่าชีส ใส่ท็อปปิ้งเป็นปูอัด และโรยหน้าทับด้วยมอสซาเรลล่าชีสอีก 1 ชั้น</p>
	        			</div>
	        		</div>
        		</div>
                <div class="pricing-entry d-flex ftco-animate">
                ...
                <div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			...
	        			<div class="d-block">
	        				<p>ทำจากแป้งพิซซ่า และซอสพิซซ่าสูตรพิเศษ โรยหน้าด้วยมอสซาเรลล่าชีส ใส่ท็อปปิ้ง เป็นไส้กรอกรมควัน และโรยหน้าทับด้วย มอสซาเรลล่าชีสอีก 1 ชั้น</p>
	        			</div>
	        		</div>
        		</div>
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			...
	        			<div class="d-block">
	        				<p>ทำจากแป้งพิซซ่าและซอสพิซซ่าสูตรพิเศษ โรยหน้าด้วยมอสซาเรลล่าชีส ใส่ท็อปปิ้ง เป็นแฮมไก่ โรยหน้าทับด้วยมอสซาเรลล่าชีสอีก 1 ชั้น</p>
	        			</div>
	        		</div>
        		</div>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			...
	        			<div class="d-block">
	        				<p>ทำจากแป้งพิซซ่าและซอสพิซซ่าสูตรพิเศษ โรยหน้าด้วยมอสซาเรลล่าชีส ใส่ท็อปปิ้ง เป็นแฮมไก่ และเห็ด โรยหน้าทับด้วยมอสซาเรลล่าชีส อีก 1 ชั้น</p>
	        			</div>
	        		</div>
        		</div>
        	</div>
